 ...
 */
public class texture2DProgramNoVBOAlpha {
    ...
    public static void use() {
        ...
        Draw3D.usingProgram = Programs.programs.texture2DProgramNoVBOAlpha;
    }

    public static void draw(FloatBuffer floatBuffer, int vertices, int texture, int textureAlpha) {
