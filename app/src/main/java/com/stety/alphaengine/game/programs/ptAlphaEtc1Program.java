 ...
 */
public class ptAlphaEtc1Program {
    ...
    public static void use() {
        ...
        Draw3D.usingProgram = Programs.programs.ptProgramAlphaEtc1;
    }
    ...
    public static void compile() {
        vertexShaderHandle = ShaderHelper.compileVertexShader(TextReaderHelper.readShader("v_pt_alpha_etc1"));
        fragmentShaderHandle = ShaderHelper.compileFragmentShader(TextReaderHelper.readShader("f_pt_alpha_etc1"));
