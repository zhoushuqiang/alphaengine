...
public class JoystickFloat {
    ...
    public Texture2DJoystickAlpha backgroundTexture;
    ...
    /**
     * Left-upper corner trigger coordinate
     */
    public short[] triggerUpperLeftCorner = null;
    /**
     * Right-lower corner trigger coordinate
     */
    public short[] triggerLowerRightCorner = null;
    /**
     * Left-upper corner background texture coordinate in DPI
     */
    public short[] backUpperLeftCornerDPI = null;
    /**
     * Right-lower corner background texture coordinate in DPI
     */
    public short[] backLowerRightCornerDPI = null;
    /**
     * Left-upper corner background texture coordinate in px
     */
    public short[] backUpperLeftCorner = null;
    /**
     * Right-lower corner background texture coordinate in px
     */
    public short[] backLowerRightCorner = null;
    /**
     * Distance in DPI
     */
    ...
    private short widthBackDPI = 0;
    private short heightBackDPI = 0;
    /**
     * Width of stick
     */
     ...
     */
    public JoystickFloat(boolean only) {
        this.only = only;
        stickTexture = new Texture2DJoystickAlpha();
        backgroundTexture = new Texture2DJoystickAlpha();
    }
    ...
    /**
     * Set Width and height of Back Joystick.
     *
     * @param width  Width in DPI.
     * @param height Height in DPI.
     */
    public void setWidthAndHeightBack(short[] width, short[] height) {
        switch (MatrixHelper.ratioRound) {
            case 177:
            default: //16:9
                this.widthBackDPI = width[3];
                this.heightBackDPI = height[3];
                break;
            case 150: //3:2
                this.widthBackDPI = width[1];
                this.heightBackDPI = height[1];
                break;
            case 133: //4:3
                this.widthBackDPI = width[0];
                this.heightBackDPI = height[0];
                break;
            case 166: //5:3
                this.widthBackDPI = width[2];
                this.heightBackDPI = height[2];
                break;
        }

        this.width = (short) (widthBackDPI * MatrixHelper.factorWidth);
    }
    ...
    public boolean action_down(short x, short y, short pointerDown) {
        ...
        if (!active && x >= triggerUpperLeftCorner[0] && x <= triggerLowerRightCorner[0] && y >= triggerUpperLeftCorner[1] && y <= triggerLowerRightCorner[1]) {
            if (Logs.Logs)
                Log.d("joystick", "joystick float action down");
            active = true;
            if (only)
                onlyNow = true;
    ...
    public void action_pointer_up(short pointerUp) {
        if (pressPointer == pointerUp) {
            if (active) {
                active = false;
                backUpperLeftCornerDPI = null;
                backLowerRightCornerDPI = null;
                backLowerRightCorner = null;
                backUpperLeftCorner = null;
            }

            if (Logs.Logs)
                Log.d("joystick", "joystick float action pointer up");
            pressPointer = -1;
        }
    }
    ...
    public void action_up() {
        ...
        if (Logs.Logs)
            Log.d("joystick", "joystick float action up");
        pressPointer = -1;
    }
    ...
    public void action_move(short x, short y) {
        this.x = (short) ((x - backUpperLeftCorner[0]) - (width / 2));
        this.y = (short) ((y - backUpperLeftCorner[1]) - (width / 2));
        ...
        if (distance <= (width / 2) - OFFSET) {
            ...
            x1 += backUpperLeftCorner[0] + (width / 2);
            y1 += backUpperLeftCorner[1] + (width / 2);
            setStickPosition(x1, y1);
        } else {
            if (Logs.Logs)
                Log.d("joystick", "joystick float action move error");
        }
    }
    ...
    private void setBackPosition(short x, short y) {
        short x1 = (short) ((20000 * x) / MatrixHelper.width);
        short y1 = (short) ((20000 * y) / MatrixHelper.height);

        backUpperLeftCornerDPI = new short[]{(short) (x1 - (widthBackDPI / 2)), (short) (y1 - (heightBackDPI / 2))};
        backLowerRightCornerDPI = new short[]{(short) (backUpperLeftCornerDPI[0] + widthBackDPI), (short) (backUpperLeftCornerDPI[1] + heightBackDPI)};
        backUpperLeftCorner = new short[]{(short) (backUpperLeftCornerDPI[0] * MatrixHelper.factorWidth), (short) (backUpperLeftCornerDPI[1] * MatrixHelper.factorHeight)};
        backLowerRightCorner = new short[]{(short) (backLowerRightCornerDPI[0] * MatrixHelper.factorWidth), (short) (backLowerRightCornerDPI[1] * MatrixHelper.factorHeight)};
        backgroundTexture.setPosition(new float[]{backUpperLeftCornerDPI[0], backUpperLeftCornerDPI[1]}, new float[]{backLowerRightCornerDPI[0], backLowerRightCornerDPI[1]});
    }
